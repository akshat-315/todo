...
const SignIn = () => {
    ...
    //sets the formData whenever there is a change in the input value
    ...
    //Signs In the user by sending an API Request to the server with the necessary fields such as email and password
