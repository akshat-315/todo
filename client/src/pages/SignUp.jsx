...
const SignUp = () => {
    ...
    // Sends a Sign-up request to the server with the required form fields, i.e. username, email and password
                        ...
                        >
                            ...
                            <div>
                                <div className="flex flex-col justify-center items-center">
                                    ...
                                    >
                                        {/* Loads a spinner while the API request is sent to the server */}
                                        {loading ? (
                                            <>
                                                <Spinner size="sm" />
                                                <span className="pl-3">
